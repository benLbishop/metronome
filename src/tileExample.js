...
// Used to load images in the createTile() function
var count = 1;
...
function createTile() {
    ...
    var width = Math.round(colspan * colSize + ((colspan - 1) * gutterStep));
    ...
    // Set the src for the image. Gets images from lorempixel in this format
    // http://lorempixel.com/width/height
    // the '?i= + count++' part prevents the browser from caching the image
    image.src = baseUrl + width + "/" + rowSize + "?i=" + count++;
    
    // Add the image to our tile element
